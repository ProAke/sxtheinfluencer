...
$data = array();
$data['from_name'] = "chanwit phuwadkien";
$data['from_email'] = "chanwit@orisma.com";
...
$data['transactional_report'] = "Full"; // โหมด report จำเป็นต้องใส่ web service ที่ เว็บไซท์ https://app2.taximail.com/app/user/system/ : False = ปิดโหมดรีพอร์ต , Unique = รีพอร์ตเฉพาะข้อมูลที่ ยูนิค , Full = รีพอร์ตทุกข้อมูล
$data['subject'] = "Test Normal Html";
$data['content_html'] = "<html><head></head><body>Hello World<a href='www.google.co.th'>Click here</a></body></html>";
...
addAddress($data['to_email'],"chanwit","chanwit@orisma.com",$get_message_id);

$message_id = ""; 
$get_message_id = genMessageID($message_id);
addAddress($data['to_email'],"wongsakorn","wongsakorn@orisma.com",$get_message_id);
